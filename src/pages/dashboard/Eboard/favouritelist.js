...
import {DrawerLayoutAndroid, StyleSheet, TextInput, View, Text, Image, TouchableOpacity, FlatList, ActivityIndicator, Animated, ImageBackground, ScrollView, Alert} from 'react-native';
...
class FavouriteList extends Component {
    ...
    getMyFavouriteArticle() {
        axios.get(`${SERVER_URL}/main/eboard/getMyFavorFiles`)
        .then(res => {
    ...
    componentWillReceiveProps = (nextProps) => {
        ...
        if(nextProps.eboard.articles) {
            // Alert.alert("sfdfdf");
            this.setState({articles: nextProps.eboard.articles});
        }
    }
                    ...
                    <View style = {{flex:4, paddingLeft:10, flexDirection:'column'}}>
                        <TouchableOpacity onPress = { () => {
                            ...
                            <View style = {{marginTop:10, flexDirection:'row'}}>
                                ...
                                <View style = {{ flexDirection:'row', flex:1}}>
                                    <Image source = {require('../../../commonUI/icon/star.png')} style = {styles.iconStyle} />
                                </View>
                            </View>  
                        </TouchableOpacity>   
                    </View>
